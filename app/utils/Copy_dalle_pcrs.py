...
class Copy_dalle_pcrs:
    ...
    def get_dalles(self) -> List: 
        ...
        """
        self.get_connexion()
        self.cur.execute("SELECT nom, geom FROM pcrs.dalle;")
    ...
    def write_dalle_in_json(self) -> None:
        ...
        try:
            ...
            with open(f"{self.path_json}/copy_grille_dalle_version2.json", "w") as outfile:
...
if __name__ == '__main__':
    generate_dalle_pcrs = Copy_dalle_pcrs(database="geoportail", user="pzgp", host="kriek2.ign.fr", password="sonia999", port="5433")
